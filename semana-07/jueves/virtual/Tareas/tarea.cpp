...
Tarea::Tarea(int id, std::string titulo, int estado){
   Fecha creacion;
   creacion.setCurrentDate();
...
std::string Tarea::getEstadoString() const{
   /**
      1- Pendiente
      2- En curso
      3- Terminado
   */
   std::string estados[3] = {"Pendiente", "En curso", "Terminado"};
   
   return estados[_estado - 1];
}
